...
object Constant {
	...
	init {
		...
		MODE_ENTITY_LIST = arrayOf(
			...
			ModeEntity("地狱模式(体验版)", GameMode.IntermediateColor, GuessColorActivity::class.java.name, bundle1),
			ModeEntity("地狱模式(中等)", GameMode.IntermediateColor, GuessColorActivity::class.java.name, bundle2),
			ModeEntity("地狱模式(困难)", GameMode.IntermediateColor, GuessColorActivity::class.java.name, bundle3),
