...
class FindDiffColorActivity : BaseActivity() {
    ...
    private val viewBinding: ActivityFindDiffColorBinding = ActivityFindDiffColorBinding.inflate(layoutInflater)
    ...
    private fun initControllerView() {
        ...
        viewBinding.ivLevelLeft.setOnClickListener { v: View? ->
            if (currentLevel > FindDiffColorViewModel.MIN_LEVEL) {
                resetLevel(currentLevel - 1)
            }
        }
        viewBinding.ivLevelRight.setOnClickListener { v: View? ->
